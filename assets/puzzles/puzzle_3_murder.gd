...
var suspects := [
	Suspect.new("سارا نیک‌پور", 165, "مشکی کوتاه", "روشن", "کت چرمی مشکی",
		"تتو کوچک روی مچ دست راست", "سریع حرف می‌زند", "res://assets/puzzles/sara.png"),
	Suspect.new("آرش کمالی", 180, "قهوه‌ای", "گندمی", "هودی طوسی",
		"ماه‌گرفتگی روی ساعد چپ", "آرام و منطقی", "res://assets/puzzles/arash.png"),
	Suspect.new("پریسا رحیمی", 170, "بلوند", "روشن", "مانتوی سبز",
		"خال روی گردن", "مضطرب", "res://assets/puzzles/parisa.png"),
	Suspect.new("نیما مرادی", 175, "مشکی", "سبزه", "پیراهن آبی",
		"تتو بزرگ بازو", "پر حرف", "res://assets/puzzles/nima.png"),
	Suspect.new("مهسا شریفی", 160, "قرمز", "روشن", "کاپشن جین",
		"بدون ویژگی خاص", "کم‌حرف", "res://assets/puzzles/mahsa.png")
]
